...
### 自动下载
> **单击需要的版本下载即可（带有**`New/新`**字样的为最新版）**
- **简体中文-原版重置-测试版**
  - [**简体中文-原版重置-测试版3.0.0**](https://github.com/ShanFlash/SCP-SL_zh_Flash/releases/download/ZH-FLASH-Demo3.0.0/ZH_FLASH_Demo_3.0.zip) New/新
